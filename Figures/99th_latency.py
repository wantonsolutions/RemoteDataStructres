...
read_write_steering_label='Swordbox'
...
if plot_writes:
    ...
    rects2 = ax1.bar(x + width , reads(read), width, label='Swordbox',color=read_write_steering_color,edgecolor='k')
else:
    rects0 = ax1.bar(x - width/2, reads(clover), width, label='Clover',color=default_clover_color,edgecolor='k')
    rects1 = ax1.bar(x + width/2 , reads(read), width, label='Swordbox',color=read_write_steering_color,edgecolor='k')
...
if plot_writes:
    ...
    rects2 = ax2.bar(x + width , writes(read), width, label='Swordbox',color=read_write_steering_color,edgecolor='k')
else:
    rects0 = ax2.bar(x - width/2, writes(clover), width, label='Clover',color=default_clover_color,edgecolor='k')
    rects1 = ax2.bar(x + width/2 , writes(read), width, label='Swordbox',color=read_write_steering_color,edgecolor='k')
