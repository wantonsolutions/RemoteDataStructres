...
Each row contains $n$ associative entries (3 in this figure, \todo{we use 8 in practice}) and
...
pointer to an extent entry for larger values.  \todo{We use 8-byte entries in our experiments, with 4-byte keys and 4-byte values.}
