...
RCuckoo delivers higher performance across a full suite of YCSB
benchmarks than all of the existing disaggregated key/value stores we
consider.  Concretely, with 400 clients RCuckoo delivers between
1.3--2.2$\times$ higher read throughput and 1.4--10$\times$ aggregate
throughput on write-heavy workloads.  Moreover, we show that RCuckoo's
