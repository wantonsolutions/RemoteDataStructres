...
RCuckoo delivers higher performance on small values across a full
suite of YCSB benchmarks than all of the existing disaggregated
...
write-intensive (YCSB-A) workloads.  Moreover, we show that RCuckoo's
