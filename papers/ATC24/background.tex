...
%%
\todo{This section needs to be at most 2 paragraphs}
\sg{Alex please skip this for now. Assume it convinces a
reader that hopscotch hashing is a candidate with less
obvious benifts compared to cuckoo hashing.}
%%
