...
\begin{figure}
  \center
  \includegraphics[width=0.80\linewidth]{fig/hero_ycsb-c.pdf}
...
\begin{figure}
  \center
  \includegraphics[width=0.80\linewidth]{fig/hero_ycsb-b.pdf}
...
\begin{figure}
  \center
  \includegraphics[width=0.80\linewidth]{fig/hero_ycsb-a.pdf}
...
\begin{figure}
  \center
  \includegraphics[width=0.65\linewidth]{fig/hero_ycsb_fill-a.pdf}
...
\begin{figure}
  \center
  \includegraphics[width=0.65\linewidth]{fig/hero_ycsb_fill-b.pdf}
...
\begin{figure}
  \center
  \includegraphics[width=0.65\linewidth]{fig/hero_ycsb_fill-c.pdf}
...
\begin{figure}
  \center
  \includegraphics[width=0.65\linewidth]{fig/hero_ycsb_fill-d.pdf}
...
\begin{figure}
\centering
      \includegraphics[width=0.70\linewidth]{fig/fault-rate.pdf}
...
\begin{figure}
\centering
        \includegraphics[width=0.70\linewidth]{fig/search_dependence.pdf}
...
\subsection{Fault Tolerance Performance}
...
\begin{figure}
\centering
        \includegraphics[width=0.70\linewidth]{fig/search_success_lock_size.pdf}
...
\begin{figure}
\centering
      \includegraphics[width=0.70\linewidth]{fig/entry_size.pdf}
...
\begin{figure}
\centering
      \includegraphics[width=0.70\linewidth]{fig/extent.pdf}
