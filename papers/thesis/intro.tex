\section{A Case for Fully Disaggregated Cuckoo Hashing}
\label{sec:cuckoo-intro}
...
In general, key-value stores rely upon a high-performance index
...
\begin{figure}
        \includegraphics[width=0.80\linewidth]{fig/rdma_latency.pdf}
...
\begin{figure}
        \center
        \includegraphics[width=0.80\linewidth]{fig/rdma_cas_throughput.pdf}
