...
def plot_hero_ycsb_fill_static():
    ...
    ax1.plot(fill_factors, write_latency, label="write", color="black", linestyle="solid", marker="o")
    ax1.plot(fill_factors, read_latency, label="read", color="black", linestyle="dashed", marker="s")
    ax1.legend(fontsize=8)
    ax1.set_ylim(bottom=0,top=40)
    ax1.set_ylabel("us")
    ax1.set_xlabel("fill factor")

    ax2.plot(fill_factors, write_bytes, label="write", color="black", linestyle="solid", marker="o")
    ax2.plot(fill_factors, read_bytes, label="read", color="black", linestyle="dashed", marker="s")
    ax2.legend(fontsize=8)
    ax2.set_ylabel("bytes/op")
    ax2.set_xlabel("fill factor")
    ax2.set_ylim(bottom=0,top=3400)


    ax3.plot(fill_factors, write_messages, label="write", color="black", linestyle="solid", marker="o")
    ax3.plot(fill_factors, read_messages, label="read", color="black", linestyle="dashed", marker="s")
    ax3.legend(fontsize=8)
    ax3.set_ylabel("messages/op")
