...
\begin{figure}[t]
  \vskip 0.5em
    \includegraphics[width=0.99\linewidth]{fig/table-diagram.png}
\vskip -0.5em
...
Table entries contain either inlined key/value pairs (bottom left) or a key and
...
inserts.
Entry and key sizes are configuration parameters, but must be fixed at
table creation.
