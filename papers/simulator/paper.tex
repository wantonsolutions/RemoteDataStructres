...
Far memory data structures cant use locks because they are
too expensive. In this work we show that with careful
algorithm and protocol design traditional data structures
can be ported to remote memory. We demonstrate this by
developing a remote memory cuckoo hash (rcuckoo).

\input{body}

\section*{Acknowledgments}

Thanks for everyone that supported me.
