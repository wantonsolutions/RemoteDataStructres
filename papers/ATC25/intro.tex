...
High access latencies are particularly challenging for systems that
...
%requests.
%Existing systems require Thus, clients must implement their own serialization protocols. These protocols use
...
frequent.
%Indeed,
%prior lock-based systems assume that clients are co-located---and can
