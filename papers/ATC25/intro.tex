...
tiers
%Current RDMA technologies have access latencies that are 20 times that of local DRAM
(e.g., RDMA access latency is approximately 1~{\textmu}s versus DRAM's 50~ns)~\cite{clover}.
